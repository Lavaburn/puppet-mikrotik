...
Puppet::Type.type(:mikrotik_v7_routing_filter_select_rule).provide(:mikrotik_api, :parent => Puppet::Provider::Mikrotik_Api) do
  ...
  def self.instances   
    ...
    filters = Puppet::Provider::Mikrotik_Api::get_all("/routing/filter/select-rule")
  ...
  def self.routingFilter(data, all_filters)
    if data['comment'] != nil
      ...
      new(
        ...
        :do_group_num   => data['do-group-num'],
        :do_group_prfx  => data['do-group-prfx'],
        :do_jump        => data['do-jump'],
        :do_select_num  => data['do-select-num'],
        :do_select_prfx => data['do-select-prfx'],
        :do_take        => data['do-take'],
        :do_where       => data['do-where']
      )
    end
  end
  ...
  def flush
    ...
    if !resource[:chain_order].nil?
      all_filters = Puppet::Provider::Mikrotik_Api::get_all("/routing/filter/select-rule")
    ...
    params["do-group-num"] = resource[:do_group_num] if !resource[:do_group_num].nil?
    params["do-group-prfx"] = resource[:do_group_prfx] if !resource[:do_group_prfx].nil?
    params["do-jump"] = resource[:do_jump] if !resource[:do_jump].nil?
    params["do-select-num"] = resource[:do_select_num] if !resource[:do_select_num].nil?
    params["do-select-prfx"] = resource[:do_select_prfx] if !resource[:do_select_prfx].nil?
    params["do-take"] = resource[:do_take] if !resource[:do_take].nil?
    params["do-where"] = resource[:do_where] if !resource[:do_where].nil?
    ...
    simple_flush("/routing/filter/select-rule", params, lookup)
        
    if !resource[:chain_order].nil?
      if @property_flush.empty?
        id_list = Puppet::Provider::Mikrotik_Api::lookup_id("/routing/filter/select-rule", lookup)
        id_list.each do |id|
  ...
  def self.moveFilter(filter_id, lookup_chain, old_chain_order, new_chain_order, all_filters)
    ...
    result = Puppet::Provider::Mikrotik_Api::move("/routing/filter/select-rule", move_params)
  end
end
